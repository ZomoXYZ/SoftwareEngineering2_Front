...
func _ready():
	...
	LobbyConn.connect("players_updated",Callable(self,"_on_players_updated"))
	LobbyConn.connect("game_starting",Callable(self,"_on_game_starting"))
	...
	if StartVars.singlePlayer:
		...
		$Background/PlayerList/Player1.add_theme_stylebox_override("normal", button_red)
		#If online, then I set all the other players slots to empty and hid their playerIcons
		$Background/Panel/LobbyID.text = "ID: %s" %ID
		$Background/PlayerList/Player2.add_theme_stylebox_override("normal", button_empty)
		$Background/PlayerList/Player2.text = ""
		$Background/PlayerList/Player2/PlayerIcon.hide()
		$Background/PlayerList/Player3.add_theme_stylebox_override("normal", button_empty)
		$Background/PlayerList/Player3.text = ""
		$Background/PlayerList/Player3/PlayerIcon.hide()
		$Background/PlayerList/Player4.add_theme_stylebox_override("normal", button_empty)
		...
		for i in range(len(players)):
			...
			current.add_theme_stylebox_override("normal", button_green)
	...
	if StartVars.isHost:
		...
		$LobbyOptions/Panel/ButtonContainer/KickPlayer.add_theme_stylebox_override("normal", button_empty)
		$LobbyOptions/Panel/ButtonContainer/KickPlayer.add_theme_stylebox_override("pressed", button_empty)
		$LobbyOptions/Panel/ButtonContainer/SetPassword.add_theme_stylebox_override("normal", button_empty)
		$LobbyOptions/Panel/ButtonContainer/SetPassword.add_theme_stylebox_override("pressed", button_empty)
		$LobbyOptions/Panel/ButtonContainer/PointGoal.add_theme_stylebox_override("normal", button_empty)
		$LobbyOptions/Panel/ButtonContainer/PointGoal.add_theme_stylebox_override("pressed", button_empty)
